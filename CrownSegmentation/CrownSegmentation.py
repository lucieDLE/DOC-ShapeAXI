...
class CrownSegmentationLogic(ScriptedLoadableModuleLogic):
  ...
  def __init__(self, surf = "None", input_csv = "None",out="None",
               overwrite="None",model="None",crown_segmentation="None",
               array_name="None",fdi="None",suffix="False",vtk_folder="None",
               dentalmodelseg_path="None"):
    """
